...
from petlandiasimple.views import CreateMedicalRecord, DisplayMedicalRecordViewsIndiv, EditMedicalRecords, DeleteMedicalRecords, DisplayMedicalRecordsViews
